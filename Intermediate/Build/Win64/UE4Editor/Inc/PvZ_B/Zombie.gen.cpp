...
// Cross Module References
	PVZ_B_API UClass* Z_Construct_UClass_AZombie_NoRegister();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AZombie_OnHit_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//controlador de eventos para responder a eventos de colision con un impacto fisico notorio como el impacto de una bala\n" },
		{ "ModuleRelativePath", "Zombie.h" },
		{ "ToolTip", "controlador de eventos para responder a eventos de colision con un impacto fisico notorio como el impacto de una bala" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AZombie_OnOverlapBeginFunction_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//declaracion de variable de tipo UStaticMeshComponent para el mesh del zombie. ZombieMeshComponentque es un puntero a un objeto de tipo UStaticMeshComponenten \n//macro para declarar funciones\n//controlador de eventos para responder a eventos de colision sin  causar un impacto fisico notorio\n" },
		{ "ModuleRelativePath", "Zombie.h" },
		{ "ToolTip", "declaracion de variable de tipo UStaticMeshComponent para el mesh del zombie. ZombieMeshComponentque es un puntero a un objeto de tipo UStaticMeshComponenten\nmacro para declarar funciones\ncontrolador de eventos para responder a eventos de colision sin  causar un impacto fisico notorio" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AZombie_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AZombie_OnHit, "OnHit" }, // 3393559595
		{ &Z_Construct_UFunction_AZombie_OnOverlapBeginFunction, "OnOverlapBeginFunction" }, // 501906049
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZombie_Statics::NewProp_ZombieMeshComponent_MetaData[] = {
		{ "Category", "Zombie" },
		{ "Comment", "//macro se utiliza para declarar variables que se pueden editar desde el editor\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Zombie.h" },
		{ "ToolTip", "macro se utiliza para declarar variables que se pueden editar desde el editor" },
	};
#endif
	...
	IMPLEMENT_CLASS(AZombie, 2288663598);
	template<> PVZ_B_API UClass* StaticClass<AZombie>()
	{
		return AZombie::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AZombie(Z_Construct_UClass_AZombie, &AZombie::StaticClass, TEXT("/Script/PvZ_B"), TEXT("AZombie"), false, nullptr, nullptr, nullptr);
